...
function SingleRestaurentCards(props) {
  ...
  const {photo = "https://www.foodiesfeed.com/wp-content/uploads/2019/06/top-view-for-box-of-2-burgers-home-made-600x899.jpg",
    name= "foodpanda" ,
    rating=5,
    isOpenNow=true,
  ...
  const ratingArray = Array.from(new Array(rating));
    return (
    <RestaurentCard>
        <RestaurentCardCover source={{uri:photo}}/>
        <CardSection>
